            ...
            <div class="header__wrap">
                <div class="header-top clearfix">
                    <div class="header-top__inner">
                        <span class="header-top__contacts">Appellez :  (237) 699 651 807</span>
                                <span class="header-top__contacts">Email : <a class="header-top__contacts-link"
                                                                              href="mailto:silvere@smartsms.cm">
                                        silvere@smartsms.cm</a></span>
                ...
                <a class="logo" href="home.html"><img class="logo__img" src="/img/logo_smart_world_1.jpg"
                                                      alt="Logo"></a>
                ...
                <div class="header__inner clearfix">
                    ...
                    <a class="header__btn btn btn-primary btn-sm btn-effect-2" href="home.html">Connectez vous</a>
                </div>
            </div>
        </header>
        <!-- end header-->
