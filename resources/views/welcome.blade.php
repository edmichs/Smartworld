            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="owl-carousel owl-theme owl-theme_mod-b enable-owl-carousel"
                        ...
                        <div class="reviews">
                            <div class="reviews__text">La solution SMARTSOLUTIONS a �t� con�ue pour tout type d�entreprises (de toute taille),
                                d�organisations ou d�institutions, et dimensionn�e en fonctions de leurs objectifs. Cette solution vient r�soudre
                                les principaux probl�mes r�guli�rement rencontr�s dans les entreprises. Voici les principaux buts de la solution
                                SMARTSOLUTIONS
                            </div>
                        ...
                        <div class="reviews">
                            <div class="reviews__text">La solution SMARTSOLUTIONS est repartie en plusieurs packages afin de donner la possibilit� � tout types
                                d�entreprises de diff�rentes tailles, de b�n�ficier des avantages offerts par la solution.  Ces packs �tant structur�es de
                                la m�me fa�on, c�est � dire int�grant tous les 5 sous produits constituant la solution SMARTSOLUTIONS,
                                mais avec des dimensionnements diff�rents
                            </div>
                            <div class="reviews__author">
                                <span class="reviews__author-title">SMARTSOLUTIONS</span>
                                <img class="reviews__signature img-responsive" src="/media/reviews/signature.png"
